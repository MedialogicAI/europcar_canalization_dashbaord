...
select.form-control:not([size]):not([multiple]) {
   ...
   <h1 align="center">Today Worked Practices</h1>
   <br>
	...
	<div class="col-md-4">
		...
		<select id="searchFields" name="searchFields" class="form-control">
			...
			<option value="5">Process Result</option>
		</select>
	</div>
	...
	<div class="col-md-4">
		<br>
		<button type="button" class="downloadPratices" style="width: 100%;height: 33px;margin-top: 6px;" onclick="location.href='../fetcher_folder/fetch_download_lista_odierne.php';"><i class="fa fa-download" aria-hidden="true"></i>
  Download CSV</button>
	</div>	
    ...
    <table id="product_data" class="table table-bordered table-striped">
     <thead>
      <tr>
	    <th style="min-width: 85px; max-width:85px" class="align-top" >
         Station code
		</th>
		...
		<th style="min-width:80px; max-width:800px" class="align-top" >Atar File</th>	
		<th class="align-top" style="min-width:280px; max-width:300px" >Process Result</th>	
		<th class="align-top">Azioni</th>
       </tr>
     </thead>
    </table>
	...
	if(fieldValue == 1 || fieldValue == 2){
		$("#search").datepicker({
			...
			onSelect: function(dateText) {
				var key = dateText;
				$('#daSvuotare').empty();
				$('#daSvuotare').html('<table id="product_data" class="table table-bordered table-striped"><thead><tr><th style="min-width: 85px; max-width:85px" class="align-top">Station code</th><th style="min-width: 120px; max-width:120px" class="align-top" >Request Date</th><th style="min-width: 125px; max-width:125px" class="align-top" >Start Process Date</th><th style="min-width: 125px; max-width:125px" class="align-top" >Registration Number</th><th style="min-width:80px; max-width:800px" class="align-top" >Atar File</th><th class="align-top" style="min-width:280px; max-width:300px" >Process Result</th><th class="align-top">Azioni</th></tr></thead></table>');	
   ...
   "paging": false,
    language: {
        "processing": "Caricamento in corso. Attendere Prego...",
		 "info": " _TOTAL_ Practices",
    },
   "serverSide":true,
   "order":[],
   "ajax":{
    url:"/fetcher_folder/fetch_lista_odierne.php",
    type:"POST",
...
$(document).ready(function(){
	...
	$(document).on('click', '.putManually', function(){

			var dataAtar = $(this).data("atar");
			
			$.ajax({
				url : '../fetcher_folder/put_in_manual.php',
				crossOrigin: true,
				type : 'POST',
				data : {
					dataAtar:dataAtar,
