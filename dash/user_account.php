        ...
        <div id='msg_out_old'>
            ...
            <div class="container pull-left">
                ...
                <div class="row">
                    ...
                    $conta_righe_rej_24 = conta_righe_con_stato_24ore ('410') + conta_righe_con_stato_24ore ('440') + conta_righe_con_stato_24ore ('460') + conta_righe_con_stato_24ore ('430') + conta_righe_con_stato_24ore ('420');
                    ...
                    <div class="col-md-12" style="margin-bottom:15px;">
						...
						<span> Total last 24 hours: <b><?php
                                ...
                                $conta_tutto_24_ore = conta_tutto_24ore();
                                echo "$total24 di $conta_tutto_24_ore"; ?></b> </span>
                    </div>
            ...
            function conta_tutto_24ore() {  // questa funzione conta tutte le pratiche del giorno comprese quelle non ancora lavorate
                global $servername; global $username; global $password; global $dbname;
                $conn = new mysqli($servername, $username, $password, $dbname);
                if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); }
                ...
                //$sql = "SELECT count(*) FROM `ataraxia_main`";
                //$sql = "SELECT count(*) FROM `ataraxia_main` WHERE dt_insert >= DATE_SUB(CURDATE(),INTERVAL 1 DAY) ";
                $sql="SELECT count(*) FROM ataraxia_main as t1 LEFT JOIN tab_status as t2 ON t1.status = t2.actual_status where dt_insert BETWEEN DATE_FORMAT(NOW(),'%Y-%m-%d') AND NOW()";
                $result = $conn->query($sql);
