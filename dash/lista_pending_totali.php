...
<script src="//cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Already addressed to supplier practices</h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
...
select.form-control:not([size]):not([multiple]) {
   ...
   <h1 align="center">lready addressed to supplier practices</h1>
   <br>
...
<div class="col-md-4">
		<br>
		<button type="button" class="downloadPratices" style="width: 100%;height: 33px;margin-top: 6px;" onclick="location.href='../fetcher_folder/fetch_download_lista_pending.php';"><i class="fa fa-download" aria-hidden="true"></i>
  Download CSV</button>
	</div>		
...
function load_data(search,field)
 {
  var dataTable = $('#product_data').DataTable({
   ...
   "order":[],
   "ajax":{
    url:"/fetcher_folder/fetch_lista_pending.php",
    type:"POST",
