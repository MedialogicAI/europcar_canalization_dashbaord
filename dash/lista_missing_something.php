...
select.form-control:not([size]):not([multiple]) {
   ...
   <h1 align="center">Rejected Practices</h1>
   <br>
	...
	<div class="col-md-4">
		<br>
		<button type="button" class="downloadPratices" style="width: 100%;height: 33px;margin-top: 6px;" onclick="location.href='../fetcher_folder/fetch_download_something.php';"><i class="fa fa-download" aria-hidden="true"></i>
  Download CSV</button>
	</div>	
    ...
    <table id="product_data" class="table table-bordered table-striped">
     <thead>
      <tr>
		...
		<th style="min-width: 60px" class="align-top" >
         Request Date
		</th>
		<th style="min-width: 55px" class="align-top" >
         Start Process Date
	...
	if(fieldValue == 1 || fieldValue == 2){
		$("#search").datepicker({
			...
			onSelect: function(dateText) {
				var key = dateText;
				$('#daSvuotare').empty();
				$('#daSvuotare').html('<table id="product_data" class="table table-bordered table-striped"><thead><tr><th style="min-width: 55px" class="align-top" >Station code</th><th style="min-width: 60px" class="align-top" >Request Date</th><th style="min-width: 55px" class="align-top" >Start Process Date</th><th style="min-width: 55px" class="align-top" >Registration Number</th><th style="width: 200px;" class="align-top" >Atar File</th><th class="align-top" >Cause</th></tr></thead></table>');	
...
function load_data(search,field)
 {
  var dataTable = $('#product_data').DataTable({
   ...
   "order":[],
   "ajax":{
    url:"/fetcher_folder/fetch_missing_something.php",
    type:"POST",
