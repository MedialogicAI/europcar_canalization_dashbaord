...
select.form-control:not([size]):not([multiple]) {
   ...
   <h1 align="center">All Practices List</h1>
   <br>
	...
	<div class="col-md-4">
		<br>
		<button type="button" class="downloadPratices" style="width: 100%;height: 33px;margin-top: 6px;" onclick="location.href='../fetcher_folder/fetch_download_tutto.php';"><i class="fa fa-download" aria-hidden="true"></i>
  Download CSV</button>
	</div>	
  <div class="table-responsive col-md-12" id="daSvuotare"  style="margin-top:20px;">
    <table id="product_data" class="table table-bordered table-striped">
     <thead>
      <tr>
		...
		<th style="width: 200px;" class="align-top" >Atar File</th>	
		<th class="align-top" >Cause</th>	
		<th class="align-top" >Supplier</th>
		<th class="align-top" >Supplier E-mail</th>
       </tr>
     </thead>
    </table>
		...
		if(fieldValue == 1 || fieldValue == 2){
			...
			$("#search").datepicker({
				...
				onSelect: function(dateText) {
					...
					$('#daSvuotare').empty();
					$('#daSvuotare').html('<table id="product_data" class="table table-bordered table-striped"><thead><tr><th style="min-width: 55px" class="align-top">Station code</th><th style="min-width: 55px" class="align-top">Request Date</th><th style="min-width: 55px" class="align-top">Start Process Date</th><th style="min-width: 55px" class="align-top">Registration Number</th><th style="width: 200px;" class="align-top" >Atar File</th><th class="align-top" >Cause</th><th class="align-top" >Supplier</th><th class="align-top" >Supplier E-mail</th></tr></thead></table>');
...
function load_data(search,field)
 {
  var dataTable = $('#product_data').DataTable({
   ...
   "order":[],
   "ajax":{
    url:"/fetcher_folder/fetch_lista_tutto.php",
    type:"POST",
