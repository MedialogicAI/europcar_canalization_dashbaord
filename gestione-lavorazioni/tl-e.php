...
{
      "value": "<?php echo '<a href=\'esportazione-lavorazioni/producer_csv_tlpmp.php\' download> '.pendingselection ().' </a>'; ?>"
}
...
// Parte funzioni PHP
	...
	function pendingselection () {	
		...
		$sql = "SELECT * FROM clienti_pre_fat_for where sm35ok > 1 and rifiutato < 2";
