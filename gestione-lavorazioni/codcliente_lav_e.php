...
// Parte funzioni PHP
	...
	function pendingselection ($idstoricizzato) {	
		...
		//$sql = "SELECT `402fattura` FROM `clienti_pre_fat_for`  where sm35ok = 1 order by id_cpff desc Limit 1";
		$sql = "SELECT `402fattura` FROM `clienti_pre_fat_for` where id_cpff = $idstoricizzato";
