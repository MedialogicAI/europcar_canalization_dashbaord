...
// Parte funzioni PHP
	...
	function pendingselection ($idfrompriority) {	
		...
		$sql = "SELECT `acquisizione_fatt` FROM `clienti_pre_fat_for` WHERE `ricevuto` = 1 AND (registratosufatfor = 0 OR registratosufatfor = 1) AND `SM35OK` = 0 AND `pdfgenerato` = 0 and id_cpff = $idfrompriority LIMIT 1";
