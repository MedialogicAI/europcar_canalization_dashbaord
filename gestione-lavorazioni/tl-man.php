...
{
      "value": "<?php echo '<a href=\'esportazione-lavorazioni/producer_csv_tlpman.php\' download> '.pendingselection ().' </a>'; ?>"
}
...
// Parte funzioni PHP
	...
	function pendingselection () {	
		...
		$sql = "SELECT * FROM clienti_pre_fat_for where rifiutato = 2";
